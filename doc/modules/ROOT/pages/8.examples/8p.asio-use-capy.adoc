...
* How a completion token adapts _any_ Asio async operation into an xref:4.coroutines/4e.io-awaitable.adoc[IoAwaitable]
* How the token bridges `std::stop_token` to Asio's cancellation slot
* How the bridge preserves the xref:4.coroutines/4d.executors.adoc#the-same-executor-invariant[same-executor invariant]
...
* xref:4.coroutines/4e.io-awaitable.adoc#bridging-a-foreign-awaitable[Bridging a Foreign Awaitable] — the general pattern
