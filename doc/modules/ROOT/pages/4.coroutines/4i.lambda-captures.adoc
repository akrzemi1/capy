...
[source,cpp]
----
include::example$snippets/4i_lambda_captures.cpp[tag=dangling_capture]
----
...
[source,cpp]
----
include::example$snippets/4i_lambda_captures.cpp[tag=iife_parameter]
----
...
[source,cpp]
----
include::example$snippets/4i_lambda_captures.cpp[tag=capture_this_broken]
----
...
[source,cpp]
----
include::example$snippets/4i_lambda_captures.cpp[tag=stored_lambda_safe,indent=0]
----
