...
[source,cpp]
----
include::example$snippets/4f_cancellation.cpp[tag=naive_flag,indent=0]
----
...
[source,cpp]
----
include::example$snippets/4f_cancellation.cpp[tag=observer_pattern,indent=0]
----
...
[source,cpp]
----
include::example$snippets/4f_cancellation.cpp[tag=immediate_invocation,indent=0]
----
...
[source,cpp]
----
include::example$snippets/4f_cancellation.cpp[tag=reset_workaround,indent=0]
----
...
[source,cpp]
----
include::example$snippets/4f_cancellation.cpp[tag=token_propagation,indent=0]
----
...
[source,cpp]
----
include::example$snippets/4f_cancellation.cpp[tag=access_stop_token,indent=0]
----
...
[source,cpp]
----
include::example$snippets/4f_cancellation.cpp[tag=check_token,indent=0]
----
...
[source,cpp]
----
include::example$snippets/4f_cancellation.cpp[tag=raii_cleanup,indent=0]
----
...
[source,cpp]
----
include::example$snippets/4f_cancellation.cpp[tag=canceled_convention,indent=0]
----
...
[source,cpp]
----
include::example$snippets/4f_cancellation.cpp[tag=inline_resume_wrong,indent=0]
----
...
[source,cpp]
----
include::example$snippets/4f_cancellation.cpp[tag=stoppable_awaitable,indent=0]
----
...
[source,cpp]
----
include::example$snippets/4f_cancellation.cpp[tag=racing_deadline,indent=0]
----
...
[source,cpp]
----
include::example$snippets/4f_cancellation.cpp[tag=user_cancellation,indent=0]
----
...
[source,cpp]
----
include::example$snippets/4f_cancellation.cpp[tag=graceful_shutdown,indent=0]
----

=== when_any Cancellation

cpp:when_any[] uses stop tokens internally to cancel "losing" tasks when the first task completes. This is covered in xref:4.coroutines/4g.composition.adoc[Concurrent Composition].
...
[source,cpp]
----
include::example$snippets/4f_cancellation.cpp[tag=include_stop_token,indent=0]
----
