...
[source,cpp]
----
include::example$snippets/4h_allocators.cpp[tag=run_async_pmr_alloc,indent=0]
----
...
[source,cpp]
----
include::example$snippets/4h_allocators.cpp[tag=run_async_memory_resource,indent=0]
----
...
[source,cpp]
----
include::example$snippets/4h_allocators.cpp[tag=recycling_observe_resource,indent=0]
----
...
[source,cpp]
----
include::example$snippets/4h_allocators.cpp[tag=recycling_observe,indent=0]
----
...
[source,cpp]
----
include::example$snippets/4h_allocators.cpp[tag=task_elidable]
----
...
[source,cpp]
----
include::example$snippets/4h_allocators.cpp[tag=halo_patterns,indent=0]
----
...
[source,cpp]
----
include::example$snippets/4h_allocators.cpp[tag=batch_allocator]
----
...
[source,cpp]
----
include::example$snippets/4h_allocators.cpp[tag=frame_scope_bad]

include::example$snippets/4h_allocators.cpp[tag=frame_scope_good]
----
...
[source,cpp]
----
include::example$snippets/4h_allocators.cpp[tag=pipeline_overlap_bad]
...
[source,cpp]
----
include::example$snippets/4h_allocators.cpp[tag=two_call,indent=0]
----

Three patterns split those two calls apart, and two of them do it without any
diagnostic. xref:4.coroutines/4c.launching.adoc[Starting Coroutines] lists all
three.
...
[source,cpp]
----
include::example$snippets/4h_allocators.cpp[tag=safe_resume,indent=0]
----
...
[source,cpp]
----
include::example$snippets/4h_allocators.cpp[tag=frame_alloc_mixin]
----
